...
import {compUpdate,fetchCompanyByEmail,getMe,emailUpdate,
    phoneUpdate,deleteComp} from '../controller/companyController.js'
...
companyRouter.use(protectCompany,restrictCompanyTo('company'))
...
companyRouter.delete('/delete',deleteComp);
